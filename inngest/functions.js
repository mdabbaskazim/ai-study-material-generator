    ...
    const notesResult = await step.run('Generate Chapter Notes', async()=>{
      ...
      await Promise.all(
          Chapters.map(async (chapter, index) => {
            ...
            make sure to give content in Format as clean HTML fragments (NO <html>, <head>, <body>, or <title> tags,Use semantic HTML5 tags: <h2>, <h3>, <h4>, <p>, <ul>, <li>, <strong>, <em>, <code>, <section>, Use <ul> and <li> tags for all lists (never use asterisks or dashes),
